...
config = { 'username': 'dvratil',
           ...
           'upload_command': 'cp %s /home/dvratil/pub/kf5/srpm/4.100.0',
           'upload_url': 'http://pub.progdan.cz/kf5/srpm/4.100.0/%s',
           'no_ssl_check': 'False',
...
tier3      = [('kf5-kconfigwidgets',        'kf5-kconfigwidgets'),
              ...
              ('kf5-kinit',                 'kf5-kinit',            'master',       ['kinit-respect-env-paths.patch']),
              ('kf5-kded',                  'kf5-kded'),
